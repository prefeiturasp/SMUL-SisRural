...
return [
    ...
    'frontend' => [
        'auth' => [
            'login_box_title' => 'Sistema de Assistência Técnica e Extensão Rural e Ambiental',
            'login_button' => 'Entrar',
        ...
        'passwords' => [
            ...
            'expired_password_box_title' => 'Resetar senha',
            'update_password_button' => 'Resetar Senha'
        ],
