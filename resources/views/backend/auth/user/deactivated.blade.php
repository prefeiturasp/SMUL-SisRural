...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-7">
                @include('backend.auth.user.includes.header-buttons', ['showAll'=>false, 'showAdd'=>false, 'showActivated'=>true, 'showDesactivated'=>false, 'showDeleted'=>true])
            </div><!--col-->
        </div><!--row-->
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        @if($users->count())
                            ...
                            @endforeach
                        @else
                            <tr><td colspan="8"><p class="text-center">@lang('strings.backend.access.users.no_deactivated')</p></td></tr>
                        @endif
                        </tbody>
                    </table>
                </div>
