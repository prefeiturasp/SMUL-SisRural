<div class="btn-group table-actions">
    ...
    @if (@$restoreUrl && Auth::user()->can('restore', @$row) || @$downloadUrl && Auth::user()->can('view', @$row) || @$sendEmailUrl && Auth::user()->can('sendEmail', @$row) || @$deleteUrl && Auth::user()->can('delete', @$row))
