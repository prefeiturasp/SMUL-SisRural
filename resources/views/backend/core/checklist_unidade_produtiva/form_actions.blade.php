<div class="btn-group table-actions">
    ...
    @if (@$addPdaUrl)
        @can('createPda', @$row)
                <a href="{!! $addPdaUrl !!}" class="btn btn-sm btn-primary" title="Criar plano de ação" style="white-space: nowrap;">
        ...
        @else
            <small class="text-muted">Sem perguntas com PDA</small>
        @endcan
    @endif
        ...
        <div class="btn-group btn-group-sm" role="group">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userActions">
                ...
                @can('view', @$row)
                    ...
                    @if (@$planoAcaoUrl)
                        <a href="{!! $planoAcaoUrl !!}" class="dropdown-item">Ver Plano de Ação</a>
                    @endif
                @endcan
                ...
                @can('restore', @$row)
                    @if (@$restoreUrl)
                        <a href="{!! $restoreUrl !!}"
                            ...
                            class="dropdown-item">Restaurar Aplicação</a>
                    @endif
                @endcan
