        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4 col-lg-4">
                    @cardaddview(['title'=>'Caderno de Campo', 'total'=>$totalCaderno, 'icon'=>'c-icon c-icon-lg cil-clipboard', 'labelAdd'=>'Novo Caderno', 'linkAdd'=>route('admin.core.cadernos.produtor_unidade_produtiva'), 'labelView'=>'Visualizar', 'linkView'=>route('admin.core.cadernos.index'), 'permissionView'=>'view menu caderno', 'permissionAdd'=>'create caderno'])
                    @endcardaddview
                </div>
