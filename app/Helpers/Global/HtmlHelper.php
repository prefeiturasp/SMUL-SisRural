...
if (!function_exists('boolean_sim_nao')) {
    function boolean_sim_nao($value)
    {
        return $value ? 'Sim' : 'Não';
    }
}

if (!function_exists('boolean_sim_nao_sem_resposta')) {
    function boolean_sim_nao_sem_resposta($value)
    {
        return @CheckboxEnum::toSelectArray()[$value];
    }
}
